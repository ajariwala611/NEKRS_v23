...
if __name__ == "__main__":
    ...
    y_grid_meas = np.linspace(0.0925, 0.1125, ny)
    ...
    predicted_LSM = predict_scalar_field(u_prime_filtered, u_bar, v_bar, dt_predict, N, x_grid_meas, x_grid_pred, y_grid_meas, y_grid_pred,z_grid_meas)
